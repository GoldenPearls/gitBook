...
### **7) 정규 표현식** <a href="#undefined" id="undefined"></a>
...
## 6. Syntax Analysis 정리: 문장을 이해하는 문법 분석기
...
| 개념                   | 설명                                              |
| -------------------- | ----------------------------------------------- |
| Syntax Analysis      | 토큰을 문법에 따라 파싱하여 구조를 분석하는 과정                     |
| Context-Free Grammar | 파스 트리를 만들기 위한 문법 규칙 모음                          |
| Terminal             | 더 이상 변환되지 않는 실제 문자 (예: X, Y, +)                 |
| Non-terminal         | 아직 변환될 수 있는 문법 구조 기호 (예: `<expr>`)              |
| Derivation           | 문법 규칙을 따라 non-terminal을 terminal로 바꿔 문장을 만드는 과정 |

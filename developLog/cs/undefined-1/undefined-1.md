...
[https://joone.net/tag/yacc/](https://joone.net/tag/yacc/)[https://joone.net/tag/yacc/](https://joone.net/tag/yacc/)[https://joone.net/tag/yacc/](https://joone.net/tag/yacc/)

![](<../../.gitbook/assets/image (277).png>)이번 장에서 프로그래밍 언어가 어떻게 구현되는지를 살펴봅니다. 기계어라는 실행 가능한 형태로 어떻게 변환되는지를 배우게 돼요\~
...
필요하시면 **그림 8-6**과 같은 파스 트리를 시각화해드릴게요! 원하시면 지금 바로 그려드릴게요.

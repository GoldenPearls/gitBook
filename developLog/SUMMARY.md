...
* [java](programming-lanuage/java/README.md)
  * [문법 정리](programming-lanuage/java/undefined/README.md)
    * [자바 문법 한눈에 정리 1편](programming-lanuage/java/undefined/1.md)
    * [자바 문법 한눈에 정리 2편](programming-lanuage/java/undefined/2.md)
    * [NullPointException에 대해 알아보자.](programming-lanuage/java/undefined/nullpointexception-..md)
    * [Call by value vs Call by Reference과 기본형과 참조형](programming-lanuage/java/undefined/call-by-value-vs-call-by-reference.md)
  * [김영한님 자바 강의 모음](programming-lanuage/java/undefined-1/README.md)
    * [자바 입문 강의 정리](programming-lanuage/java/undefined-1/undefined.md)
...
* [기본 지식](spring/undefined/README.md)
  ...
  * [스프링부트 동작원리](spring/undefined/undefined-1.md)
  * [JPA란 무엇인가요?](spring/undefined/jpa.md)
  * [messageConverter가 무엇인가요?](spring/undefined/messageconverter.md)
...
* [그 외 etc](cs/etc/README.md)
  * [멀티캠퍼스에서 배운 cs 지식](cs/etc/cs.md)

## Algorithm-DataStructure

* [Algorithm 관련 bookmark](algorithm-datastructure/algorithm-bookmark.md)
* [자료구조](algorithm-datastructure/undefined/README.md)
  * [Big O](algorithm-datastructure/undefined/big-o.md)
  * [연결 리스트](algorithm-datastructure/undefined/undefined.md)
  * [BigInteger에 대한 정리](algorithm-datastructure/undefined/biginteger.md)
  * [배열(array)](algorithm-datastructure/undefined/array.md)
  * [스택과 큐](algorithm-datastructure/undefined/undefined-1.md)
  * [Array vs ArrayList vs LinkedList 차이](algorithm-datastructure/undefined/array-vs-arraylist-vs-linkedlist.md)
  * [재귀함수](algorithm-datastructure/undefined/undefined-2.md)
  * [트리](algorithm-datastructure/undefined/undefined-3.md)
  * [우선순위 큐와 힙의 차이](algorithm-datastructure/undefined/undefined-4.md)
...
* [객체지향의 오해와 사실](book/undefined-2/README.md)
  * [1장 : 협력하는 객체들의 공동체](book/undefined-2/1.md)
...
* [강연 및 컨퍼런스 후기(lect)](tip-bookmark/conference/README.md)
  * [점핏 강연 센스있는 BE 되기](tip-bookmark/conference/be.md)
* [커피챗(coffeechat)](tip-bookmark/coffeechat/README.md)
...
* [자격증 :  certiicate](ex/certiicate/README.md)
  * [정보처리기사](ex/certiicate/undefined/README.md)
    * [필기](ex/certiicate/undefined/undefined.md)
    * [실기](ex/certiicate/undefined/undefined-1.md)
    * [대학생, 취준생, 신입개발자의 과정과 함께한 정보처리기사 4트 2024년 1회 실기 후기](ex/certiicate/undefined/4-2024-1.md)
  * [SQLD](ex/certiicate/sqld.md)
  * [ADsP](ex/certiicate/adsp.md)
* [notion 템플릿 나눔](ex/theme/README.md)
  * [노션 팀 스터디 템플릿 공유](ex/theme/undefined.md)
  * [팀프로젝트 관련 노션 템플릿 공유](ex/theme/undefined-1.md)
* [신입개발자(new dev) > 주니어 개발자의 취업과 이직, 업무 이야기](ex/new-dev-greater-than/README.md)
  * [신입개발자의 중소, SI 취준기 및 성장](ex/new-dev-greater-than/si/README.md)
    * [애매한 신입개발자의 중소, si 취준기(feat. 이력서 및 포트폴리오 작성법, 면접 후기) - 간추린 버전](ex/new-dev-greater-than/si/si-feat..md)
    * [애매한 쌩신입개발자 중소, si 취준기 1탄 이력서 및 포트폴리오 작성법 및 후기](ex/new-dev-greater-than/si/si-1.md)
    * [애매한 쌩신입개발자 중소, si 취준기 2탄 면접 후기, 질문, 취업 관련 사이트 모음, 결과](ex/new-dev-greater-than/si/si-2.md)
    * [주니어가 첫 회사 다니면서 깨달은(?깨달아가는) 20가지](ex/new-dev-greater-than/si/20.md)
* [살아가는 이야기(life)](ex/life/README.md)
  * [대학 입학 전 \~ 취업 전까지의 아르바이트 회고](ex/life/undefined.md)
* [얻은 지식 모음](ex/undefined/README.md)
  * [트위터를 통한 모르는 지식을 얻어가기](ex/undefined/undefined.md)

...
* [자바](programming-lanuage/java/README.md)
  * [문법 정리](programming-lanuage/java/grammar/README.md)
    ...
    * [StringBuffer vs String vs StringBuilder](programming-lanuage/java/grammar/stringbuffer-vs-string-vs-stringbuilder.md)
  ...
  * [이펙티브 자바](programming-lanuage/java/effective-java/README.md)
    * [2장 : 객체 생성과 파괴](programming-lanuage/java/effective-java/2/README.md)
      * [item 01. 생성자를 대신 정적 팩토리 메서드를 고려하라](programming-lanuage/java/effective-java/2/item-01..md)
      * [item 02. 생성자에 매개변수가 많다면 빌더를 고려하라](programming-lanuage/java/effective-java/2/item-02..md)
      * [item 03 : private 생성자나 열거 타입으로 싱글턴임을 보증하라.](programming-lanuage/java/effective-java/2/item-03-private-..md)
      * [item 04 : 인스턴스화를 막으려거든 private 생성자를 사용하라](programming-lanuage/java/effective-java/2/item-04-private.md)
      * [item 05 : 자원을 직접 명시하지 말고 의존 객체 주입을 사용하라](programming-lanuage/java/effective-java/2/item-05.md)
      * [item 06 : 불필요한 객체 생성을 피하라](programming-lanuage/java/effective-java/2/item-06.md)
      * [item 07 : 다 쓴 객체 참조를 해제하라](programming-lanuage/java/effective-java/2/item-07.md)
      * [item 08 : finalizer와 cleaner 사용을 피하라](programming-lanuage/java/effective-java/2/item-08-finalizer-cleaner.md)
      * [item 09 : try-finally보다는 tiy-with-resources를 사용하라](programming-lanuage/java/effective-java/2/item-09-try-finally-tiy-with-resources.md)
    * [3장 : 모든 객체의 공통 메서드](programming-lanuage/java/effective-java/3/README.md)
      * [item10 : equals는 일반 규약을 지켜 재정의하라](programming-lanuage/java/effective-java/3/item10-equals.md)
    ...
    * [4장 : 클래스와 인터페이스](programming-lanuage/java/effective-java/4/README.md)
      * [item 15 : 클래스와 멤버의 접근 권한을 최소화하라](programming-lanuage/java/effective-java/4/item-15.md)
      * [item 16 : public 클래스에서는 public 필드가 아닌 접 근자 메서드를 사용하라](programming-lanuage/java/effective-java/4/item-16-public-public.md)
      * [item 17 : 변경 가능성을 최소화하라](programming-lanuage/java/effective-java/4/item-17.md)
      * [item 18 : 상속보다는 컴포지션을 사용하라](programming-lanuage/java/effective-java/4/item-18.md)
      * [item 19 : 상속을 고려해 설계하고 문서화하라. 그러지 않았다면 상속을 금지하라](programming-lanuage/java/effective-java/4/item-19-..md)
      * [item 20 : 추상클래스보다는 인터페이스를 고려하라](programming-lanuage/java/effective-java/4/item-20.md)
      * [item 21 : 인터페이스는 구현하는 쪽을 생각해 설계하라](programming-lanuage/java/effective-java/4/item-21.md)
      * [item 22 : 인터페이스는 타입을 정의하는 용도로만 사용하라](programming-lanuage/java/effective-java/4/item-22.md)
      * [item 23 : 태그 달린 클래스보다는 클래스 계층구조를 활용하라](programming-lanuage/java/effective-java/4/item-23.md)
    ...
    * [5장 : 제네릭](programming-lanuage/java/effective-java/5/README.md)
      ...
      * [item 33 : 타입 안전 이종 컨테이너를 고려하라](programming-lanuage/java/effective-java/5/item-33.md)
    * [6장 : 열거 타입과 애너테이션](programming-lanuage/java/effective-java/6/README.md)
      ...
      * [item 38 : 확장할 수 있는 열거 타입이 필요하면 인터페이스를 사용하라](programming-lanuage/java/effective-java/6/item-38.md)
      * [item 39 : 명명 패턴보다 애너테이션을 사용하라](programming-lanuage/java/effective-java/6/item-39.md)
      * [item 40 : @Override 애너테이션을 일관되게 사용하라](programming-lanuage/java/effective-java/6/item-40-override.md)
      * [item 41 : 정의하려는 것이 타입이라면 마커 인터페이스를 사용하라](programming-lanuage/java/effective-java/6/item-41.md)
      * [보충 : 리플렉션과 애너테이션](programming-lanuage/java/effective-java/6/undefined.md)
    ...
    * [8장 : 메서드](programming-lanuage/java/effective-java/8/README.md)
      ...
      * [item 54 : null이 아닌, 빈 컬렉션이나 배열을 반환하라](programming-lanuage/java/effective-java/8/item-54-null.md)
      * [item 55 : 옵셔널 반환은 신중히 하라](programming-lanuage/java/effective-java/8/item-55.md)
    ...
    * [10장 : 예외](programming-lanuage/java/effective-java/10/README.md)
      ...
      * [item 71 : 필요 없는 검사 예외 사용은 피하라](programming-lanuage/java/effective-java/10/item-71.md)
  ...
  * [그 외 용어 정리](programming-lanuage/java/undefined/README.md)
    ...
    * [콜백(callback)](programming-lanuage/java/undefined/callback.md)
    * [@PreDestroy 어노테이션](programming-lanuage/java/undefined/predestroy.md)
    * [AutoCloseable 인터페이스](programming-lanuage/java/undefined/autocloseable.md)
    ...
    * [스레드 안전성](programming-lanuage/java/undefined/undefined-3.md)
    * [어댑터란?](programming-lanuage/java/undefined/undefined-4.md)
...
* [한권으로 읽는 컴퓨터 구조와 프로그래밍](cs/undefined-1/README.md)
  ...
  * [『한 권으로 읽는 컴퓨터 구조와 프로그래밍』 12\~13장](cs/undefined-1/12-13.md)
...
* [HTTP 웹 지식](cs/http/README.md)
  * [김영한님 강의](cs/http/undefined/README.md)
    * [인터넷 네트워크](cs/http/undefined/undefined.md)
    * [URI와 웹 브라우저의 요청 흐름](cs/http/undefined/uri.md)
    * [HTTP의 기본](cs/http/undefined/http.md)
    * [HTTP 메서드](cs/http/undefined/http-1.md)
    * [HTTP 메서드 활용](cs/http/undefined/http-2.md)
    * [HTTP 상태코드](cs/http/undefined/http-3.md)
    * [HTTP 헤더 1 - 일반 헤더](cs/http/undefined/http-1-1.md)
    * [HTTP 헤더 2 - 캐시와 조건부 요청](cs/http/undefined/http-2-1.md)
    * [응답 206 partial content](cs/http/undefined/206-partial-content.md)
  * [Http 완벽 가이드 책](cs/http/http/README.md)
    * [1부 Http의 웹의 기초](cs/http/http/1-http.md)
...
* [github](ci-cd/github/README.md)
  ...
  * [github.io 블로그 만들기](ci-cd/github/github.io/README.md)
    ...
    * [Jekyll Chirpy 테마를 연동 및 Github 블로그 만들기 4탄 - 세부사항](ci-cd/github/github.io/jekyll-chirpy-github-4.md)
...
* [2024년](memoir/2024/README.md)
  ...
  * [다양한 경험을 쌓아가며, 자바 카페 스터디, 튜사콘, 글또와 함께 하는 나를 되돌아본 2024년 9월 회고록](memoir/2024/2024-9.md)
  * [글또 시작하고 스터디 마무리 지은 2024년 10월 회고록 (티스토리도 시작😶, 약간 당황한 일...문자로 질문?)](memoir/2024/2024-10-....md)
